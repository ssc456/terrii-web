...
import { createCareHomes } from "../graphql/mutations";
const client = generateClient();
export default function CareHomesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCareHome(initialValues.CareHome);
    ...
    setLocalAuthority(initialValues.LocalAuthority);
    setRegion(initialValues.Region);
    setServiceGroup(initialValues.ServiceGroup);
    setCQCURL(initialValues.CQCURL);
    setProviderID(initialValues.ProviderID);
    setProviderName(initialValues.ProviderName);
    setRatingCaring(initialValues.RatingCaring);
    setRatingEffective(initialValues.RatingEffective);
    setRatingResponsive(initialValues.RatingResponsive);
    setRatingSafe(initialValues.RatingSafe);
    setRatingWellLed(initialValues.RatingWellLed);
    setRatingOverall(initialValues.RatingOverall);
    setNHSRegion(initialValues.NHSRegion);
    setReportDate(initialValues.ReportDate);
    setIRatingCaring(initialValues.iRatingCaring);
    setIRatingEffective(initialValues.iRatingEffective);
    setIRatingResponsive(initialValues.iRatingResponsive);
    setIRatingSafe(initialValues.iRatingSafe);
    setIRatingWellLed(initialValues.iRatingWellLed);
    setIRatingOverall(initialValues.iRatingOverall);
    setErrors({});
  };
  const validations = {
    LocationID: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCareHomes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CareHomesCreateForm")}
      {...rest}
    >
      <TextField
        label="Location id"
