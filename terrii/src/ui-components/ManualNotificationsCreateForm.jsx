...
import { createManualNotifications } from "../graphql/mutations";
const client = generateClient();
export default function ManualNotificationsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setShortText(initialValues.shortText);
    setErrors({});
  };
  const validations = {
    title: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createManualNotifications.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ManualNotificationsCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
