...
import { createGuidanceTypes } from "../graphql/mutations";
const client = generateClient();
export default function GuidanceTypesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createGuidanceTypes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "GuidanceTypesCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
