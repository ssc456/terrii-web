...
export default function CommunityGroupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setImageS3Key(initialValues.imageS3Key);
    setHeaderS3Key(initialValues.headerS3Key);
    setErrors({});
  };
  const validations = {
    name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCommunityGroup.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CommunityGroupCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
