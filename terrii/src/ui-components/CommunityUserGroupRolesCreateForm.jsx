...
export default function CommunityUserGroupRolesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setUserGroupRole(initialValues.userGroupRole);
    setErrors({});
  };
  const validations = {
    userGroupRole: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCommunityUserGroupRoles.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CommunityUserGroupRolesCreateForm")}
      {...rest}
    >
      <SelectField
