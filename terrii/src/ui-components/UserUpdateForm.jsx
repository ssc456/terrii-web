...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setPwdName(cleanValues.pwdName);
    setExpoNotificationToken(cleanValues.expoNotificationToken);
    setNativeNotificationToken(cleanValues.nativeNotificationToken);
    setPostRegistrationComplete(cleanValues.postRegistrationComplete);
    setAdditionalInformationComplete(cleanValues.additionalInformationComplete);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          nativeNotificationToken: nativeNotificationToken ?? null,
          postRegistrationComplete: postRegistrationComplete ?? null,
          additionalInformationComplete: additionalInformationComplete ?? null,
