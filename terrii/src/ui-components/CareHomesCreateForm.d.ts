...
export declare type CareHomesCreateFormInputValues = {
    LocationID?: string;
    Name?: string;
    CareHome?: string;
    Type?: string;
...
export declare type CareHomesCreateFormValidationValues = {
...
export declare type CareHomesCreateFormOverridesProps = {
    CareHomesCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CareHomesCreateFormProps = React.PropsWithChildren<{
    overrides?: CareHomesCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: CareHomesCreateFormInputValues) => CareHomesCreateFormInputValues;
    onSuccess?: (fields: CareHomesCreateFormInputValues) => void;
    onError?: (fields: CareHomesCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CareHomesCreateFormInputValues) => CareHomesCreateFormInputValues;
    onValidate?: CareHomesCreateFormValidationValues;
} & React.CSSProperties>;
export default function CareHomesCreateForm(props: CareHomesCreateFormProps): React.ReactElement;
