...
import { createSystemInfo } from "../graphql/mutations";
const client = generateClient();
export default function SystemInfoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSystemInfo.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SystemInfoCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
