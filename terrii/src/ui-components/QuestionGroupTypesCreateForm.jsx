...
import { createQuestionGroupTypes } from "../graphql/mutations";
const client = generateClient();
export default function QuestionGroupTypesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setIconS3URL(initialValues.iconS3URL);
    setErrors({});
  };
  const validations = {
    name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createQuestionGroupTypes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "QuestionGroupTypesCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
