...
import { updateCalendar } from "../graphql/mutations";
const client = generateClient();
export default function CalendarUpdateForm(props) {
  const {
    id: idProp,
    calendar: calendarModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [calendarRecord, setCalendarRecord] = React.useState(calendarModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getCalendar.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getCalendar
        : calendarModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateCalendar.replaceAll("__typename", ""),
            variables: {
              input: {
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || calendarModelProp)}
