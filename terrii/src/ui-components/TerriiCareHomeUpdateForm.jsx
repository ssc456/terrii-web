...
import { updateTerriiCareHome } from "../graphql/mutations";
const client = generateClient();
export default function TerriiCareHomeUpdateForm(props) {
  const {
    id: idProp,
    terriiCareHome: terriiCareHomeModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = terriiCareHomeRecord
      ? { ...initialValues, ...terriiCareHomeRecord }
      : initialValues;
  ...
  const [terriiCareHomeRecord, setTerriiCareHomeRecord] = React.useState(
    terriiCareHomeModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getTerriiCareHome.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getTerriiCareHome
        : terriiCareHomeModelProp;
      setTerriiCareHomeRecord(record);
    };
    queryData();
  }, [idProp, terriiCareHomeModelProp]);
  React.useEffect(resetStateValues, [terriiCareHomeRecord]);
  const validations = {
    name: [{ type: "Required" }],
    address: [],
    city: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateTerriiCareHome.replaceAll("__typename", ""),
            variables: {
              input: {
                id: terriiCareHomeRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "TerriiCareHomeUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || terriiCareHomeModelProp)}
