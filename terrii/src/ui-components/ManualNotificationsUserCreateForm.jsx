...
import { createManualNotificationsUser } from "../graphql/mutations";
const client = generateClient();
export default function ManualNotificationsUserCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createManualNotificationsUser.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ManualNotificationsUserCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Seen"
